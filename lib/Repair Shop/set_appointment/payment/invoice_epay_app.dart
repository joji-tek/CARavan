...
class InvoiceEpayApp extends StatefulWidget {
  const InvoiceEpayApp({Key? key}) : super(key: key);

  @override
  _InvoiceEpayAppState createState() =>
      _InvoiceEpayAppState();
}

class _InvoiceEpayAppState extends State<InvoiceEpayApp> {
                ...
                child: Column(
                  ...
                  children: [
                   ...
                   _buildBookingDetailRow('Additional Notes:', _latestAppointment[AppointmentsDBHelper.columnAdditionalNotes] ?? 'None'!), 
                    ...
                    _buildBookingDetailRow('(Paid) Price : ', '₱${_latestAppointment[AppointmentsDBHelper.columnPrice].toStringAsFixed(2)!}'),
                    SizedBox(height: 20),

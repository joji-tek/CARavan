...
import 'package:user1_bookingrepair/Repair%20Shop/set_appointment/payment/invoice_epay_app.dart';
class AppointmentEpaymentScreen extends StatefulWidget {
  final double totalAmount;
  final int transactionStatus;

  const AppointmentEpaymentScreen({Key? key, 
  required this.totalAmount, 
  required this.transactionStatus, 
  required int bookingId, 
  required bool isTransactionSuccessful}) : super(key: key);

  @override
  _AppointmentEpaymentScreenState createState() => _AppointmentEpaymentScreenState();
}

class _AppointmentEpaymentScreenState extends State<AppointmentEpaymentScreen> {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => InvoiceEpayApp(),
                          ),
                        );
                      },

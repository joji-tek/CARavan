...
class InvoiceEpayment extends StatefulWidget {
  final double totalAmount;
  final int bookingId;

  const InvoiceEpayment({
    super.key,
  ...
  @override
  _InvoiceEpaymentState createState() => _InvoiceEpaymentState();
}

class _InvoiceEpaymentState extends State<InvoiceEpayment> {
  String? carModel;
  String? licensePlate;
            ...
            child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text(
                      'Total Amount: \₱${widget.totalAmount.toStringAsFixed(2)} -PAID', // Append " - Paid" if transactionStatus is 2
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
                    ),
